...
public class IMETree {
	 ...
	 *            the characters
	 * @param frequency
	 *            the frequency of the word occurance
	 */
	 ...
	 *            the map to set
	 */
	public void setCachewords(
			final Map<Integer, Map<String, Set<String>>> cachewords) {
	...
	public String toString() {
		return "Nodevalue: " + word + " IsWord: " + isWord + " Freq: "
				+ frequency + " Children: " + this.children.size() + " "
				+ this.cachewords.toString();
	}
}
