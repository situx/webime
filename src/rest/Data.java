...
public class Data {
	 ...
	 * Reads and builds imetrees from the given corpus file in the ime folder.
	 */
	private Data(){
		...
		for(String file:this.treebuilders.keySet()){
			methods+="<option value=\""+file.substring(0,file.lastIndexOf('.'))+"\">"+Character.toUpperCase(file.charAt(0))+file.substring(1,file.lastIndexOf('.'))+"</option>";
	 ...
	 * @param treebuilders the map of treebuilders to set
	 */
